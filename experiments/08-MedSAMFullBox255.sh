...
#SBATCH --job-name=MedSAMBoxFull255
#SBATCH --output=/lustre07/scratch/jieying/Medical-SAM-Adapter/out/08-MedSAMFullBox255.out
...
tar xf /lustre07/scratch/jieying/Medical-SAM-Adapter/data/train/train_255.tar -C $SLURM_TMPDIR/data
